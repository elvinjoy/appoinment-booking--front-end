            ...
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
               ...
               <div>
                  <div className='lg:w-[570px]'>
                     ...
                     <p className='text_para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates, pariatur aut inventore officia soluta sequi dolor dolorum corporis minima ab commodi amet quam enim beatae autem, harum veniam, nam aspernatur!</p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                ...
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>World-class care for everyone. Our health system sffers unmatched, expert health care. From the lab to the clinic</p>
            ...
            <div className="flex items-center justify-between flex-col lg:flex-row">
              ...
              <div className='xl:w-[670px]'>
                ...
                <ul className='pl-4'>
                  ...
                  <li className="text_para">3. View our physicians who are accepting new patients, we use the online schedule toll to select appointement time.</li>
                </ul>
                ...
                <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-[6px] lg:gap-3">
                      ...
                      <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-textColor font-[600]'>Tue, 24</p>
                    </div>
