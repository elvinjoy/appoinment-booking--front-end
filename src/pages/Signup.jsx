      ...
      <div className='grid grid-col-1 lg:grid-cols-2'>
        ...
        <div className='rounded-l-lg lg:pl-16 py-10'>
          ...
          <div className='mb-5 flex items-center justify-between '>
            ...
            <select name="role" id="" value={formData.role} onChange={handleInputChange} className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none'>
            ...
            <select name="gender" id="" value={formData.gender} onChange={handleInputChange} className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none'>
